...
import com.hz.mymeishi.View.ThreadPoolManager;
import com.hz.mymeishi.adapter.SpjugelistAdapter;
...
public class GoodsDetaillsActivity extends BaseActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("dwwaaa",goodshopid+"*****"+goodsid);
        initView();
        initDate();
        initDiss();
       yanshicao();
    ...
    private void initView() {
        ...
        //商品数量
        details_tv_cart_goods_amount =(TextView) findViewById(R.id.details_tv_cart_goods_amount);
        ...
        RxHttpUtils
                ...
                . subscribe(new Observer<Goosmessges>(){
                    ...
                    public void onNext( final Goosmessges goosmessges) {
                        ...
                        details_tv_cart_goods_amount.setText(goosmessges.getData().getSellNum()+"");
