...
import com.hz.mymeishi.activity.GoodsDetaillsActivity;
...
//        Intent intent = new Intent(mContext, SHopdetailsActivity.class);
    ...
    private class ViewHolder0 extends RecyclerView.ViewHolder {
        ...
        private void initView(View itemView) {
            ...
            iv_add_to_shop =(ImageView) itemView.findViewById(R.id.iv_add_to_shop);
            iv_add_to_shop.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
