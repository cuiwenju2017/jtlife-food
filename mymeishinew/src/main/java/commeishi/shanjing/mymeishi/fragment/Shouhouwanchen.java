...
public class Shouhouwanchen extends BaseFragment {

    private RecyclerView wanchengshouh;
    ...
    protected int setLayoutId() {
        return R.layout.fragment_shouhouwanchen;
    }
    ...
    private void initView(View view) {
        wanchengshouh = (RecyclerView)view.findViewById(R.id.wanchengshouh);
    }
    private void initDSS() {
        ...
        wanchengshouh.setLayoutManager(linearLayoutManager);
        refunAdapter = new RefunAdapter(getActivity());
        wanchengshouh.setAdapter(refunAdapter);
    }
