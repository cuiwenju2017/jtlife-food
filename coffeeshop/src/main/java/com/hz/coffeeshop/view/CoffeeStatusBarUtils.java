package com.hz.coffeeshop.view;
...
public class CoffeeStatusBarUtils {
    ...
    public CoffeeStatusBarUtils(Activity activity) {
        mActivity = activity;
    }

    public static CoffeeStatusBarUtils with(Activity activity) {
        return new CoffeeStatusBarUtils(activity);
    }
    ...
    public CoffeeStatusBarUtils setColor(int color) {
        mColor = color;
        return this;
    }
    ...
    public CoffeeStatusBarUtils setDrawable(Drawable drawable) {
        mDrawable = drawable;
        return this;
    }
    ...
    public CoffeeStatusBarUtils setIsActionBar(boolean actionBar) {
     ...
     * @return
     */
    public CoffeeStatusBarUtils setDrawerLayoutContentId(boolean drawerLayout, int contentId) {
     ...
     * 去除 ActionBar 阴影
     */
    public CoffeeStatusBarUtils clearActionBarShadow() {
